        ...
        <div class="py-1">
            <div class="row justify-content-end">
                <div class="col-8">
                    <h3><?= $pageTitle ?></h3>
                    <p class="small">
                        <?php TranslateHelper::printTranslate('Crie popups incríveis para suas páginas clonadas')?>
                    </p>
                </div>
                <div class="col-4 text-right">
                    <a class="btn btn-success btn-sm" href="https://wpsuperlinks.top/pro" target="_blank"><?= TranslateHelper::getTranslate('Novo Popup [Pro]') ?></a>
                </div>
            </div>
            <hr>
        </div>
