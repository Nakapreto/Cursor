...
//	        ['hook' => 'wp_logout', 'function' => array($this, 'removeSPLCLogout')],
    ...
    public function menuLabels(){
        return [
            ...
            'super_links_edit_groupCookie' => TranslateHelper::getTranslate('Editar categoria de cookies'),
            'super_links_edit_groupClone' => TranslateHelper::getTranslate('Editar categoria de clones'),
            'super_links_addClone' => TranslateHelper::getTranslate('Adicionar Clone'),
            'super_links_edit_clone' => TranslateHelper::getTranslate('Editar Clone'),
            'super_links_clone_page' => TranslateHelper::getTranslate('Duplicar Clone'),
            'super_links_view_clone_page' => TranslateHelper::getTranslate('Visualizar Clone'),
            'super_links_edit_AutomaticGroup' => TranslateHelper::getTranslate('Editar categoria de links automáticos'),
            'super_links_faq' => TranslateHelper::getTranslate('FAQ'),
            'super_links_adsLibrary' => TranslateHelper::getTranslate('Biblioteca de Anúncios'),
            'super_links_opniao_Clone' => TranslateHelper::getTranslate('Opinião sobre clone'),
        ];
    }
