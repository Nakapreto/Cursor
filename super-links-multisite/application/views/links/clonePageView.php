        ...
        <div class="py-1">
            <div class="row justify-content-end">
                <div class="col-8">
                    <h3><?= $pageTitle ?></h3>
                    <p class="small">
                        <?php TranslateHelper::printTranslate('Você pode clonar páginas para Google ads e muito mais...')?>
                    </p>
                </div>
                <div class="col-4 text-right">
                    <a class="btn btn-success btn-sm" href="https://wpsuperlinks.top/pro" target="_blank"><?= TranslateHelper::getTranslate('Clonar nova Página [Pro]') ?></a>
                </div>
            </div>
            <hr>
        </div>
